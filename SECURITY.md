...
- **GitHub Security Advisories** — [open a private report](https://github.com/semitexa/semitexa-cache/security/advisories/new).
...
In scope: anything in `semitexa/cache` that lets a request, a job or a message do
